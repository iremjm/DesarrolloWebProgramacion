...
public class PlantacionesUIREc extends JFrame {
	...
	private static PlantacionesUI frmPrincipal;
	...
	public PlantacionesUIREc(PlantacionesUI frmPrincipal, GestorPlantaciones gp, Plantacion p_seleccionada) {
		this.p_seleccionada = p_seleccionada;
		setTitle("Recolectar");
		...
		//format o parse con sdf
		txtFechaRec = new JTextField(/*this.p_seleccionada.getFechaRec()*/);
		...
		labelFechaRecol.setBounds(36, 101, 115, 14);
	...
	private void btnAceptarClick(){
		...
		//crear una plantacion con datos
		 Plantacion(parcela,fechaRec,especie,cantRecol);
